...
def make_dark_palette() -> QPalette:
    ...
    palette.setColor(QPalette.ColorRole.PlaceholderText, QColor(150, 150, 150))  # a softer gray for placeholders
...
class Application:
    ...
    def read_config(self):
        ...
        try:
            ...
            try:
                is_in_dark_mode = config_parser.get("cnapy-config", "is_in_dark_mode")
            ...
            self.appdata.use_results_cache = config_parser.getboolean(
                "cnapy-config", "use_results_cache", fallback=self.appdata.use_results_cache
            )
            self.appdata.results_cache_dir = Path(
                config_parser.get("cnapy-config", "results_cache_directory", fallback=self.appdata.results_cache_dir)
            )
    ...
    def read_cobrapy_config(self):
        ...
        try:
            ...
            try:
                ...
                print(
                    "Cannot set solver from cobrapy-config.txt file because:",
                    e,
            ...
            try:
                ...
                print(
                    "Cannot set number of processes from cobrapy-config.txt file because:",
                    e,
