...
def get_solver_buttons(appdata) -> tuple[QVBoxLayout, QButtonGroup]:
    ...
    if CPLEX not in avail_solvers:
        ...
        solver_buttons[CPLEX].setToolTip(
            "CPLEX is not set up with your python environment. "
    ...
    if GUROBI not in avail_solvers:
        ...
        solver_buttons[GUROBI].setToolTip(
            "Gurobi is not set up with your python environment. "
    ...
    if GLPK not in avail_solvers:
        ...
        solver_buttons[GLPK].setToolTip(
            "GLPK is not set up with your python environment. "
    ...
    if SCIP not in avail_solvers:
        ...
        solver_buttons[SCIP].setToolTip(
            "SCIP is not set up with your python environment. "
    ...
    solver_buttons["OPTLANG"].setToolTip(
        "optlang_enumerator supports calculation of reaction MCS only.\n"
